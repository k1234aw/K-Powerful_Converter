...
- Convert PDF pages to image formats, or export PDFs to Markdown with either fast plain embedded-text extraction, Windows OCR, or macOS Apple Vision OCR. OCR Markdown also keeps likely equation lines as LaTeX display math when recognizable math symbols are present.
